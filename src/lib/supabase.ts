...
if (!url || !anonKey) {
  console.warn('VITE_SUPABASE_URL / VITE_SUPABASE_ANON_KEY manquants : compte et sauvegarde désactivés (mode one-shot uniquement)')
}
...
// boots in one-shot mode (no account) when Supabase isn't configured.
